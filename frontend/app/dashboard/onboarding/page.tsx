...
export default function OnboardingPage() {
    ...
    const allCentralAsiaCountriesSelected = centralAsiaCountries.every((country) =>
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        if (
            ...
            setError('Complete the required company fields before submitting.');
            return;
        }
        ...
        try {
            ...
            setError('Company onboarding could not be submitted.');
        } finally {
            setSaving(false);
        }
    };
        ...
        setForm((current) => {
            ...
            return {
                ...
                target_countries: selected
                    ...
                    : Array.from(new Set([...current.target_countries, ...centralAsiaCountries])),
            };
        });
    };
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight text-white">Company onboarding</h1>
                    <p className="text-sm text-gray-400">Submit your company profile for pilot approval.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <section className="border border-gray-800 bg-gray-950 rounded-lg p-6 space-y-5">
                    ...
                    <div className="space-y-3">
                        <span className={labelClass}>Target regions</span>
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() =>
                                            setForm((current) => ({
                                                ...current,
                                                target_regions: toggleValue(current.target_regions, region),
                                            }))
                                        }
                    ...
                    <div className="space-y-3">
                        <span className={labelClass}>Central Asia countries</span>
                        <button
                            type="button"
                        ...
                        >
                            ...
                            {allCentralAsiaCountriesSelected ? 'Clear Central Asia' : 'Select all Central Asia'}
                        </button>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() =>
                                            setForm((current) => ({
                                                ...current,
                                                target_countries: toggleValue(current.target_countries, country),
                                            }))
                                        }
                                        className={`flex items-center justify-between rounded-lg border px-4 py-3 text-sm transition-colors ${
                                            selected
                        ...
                        <span className="text-xs text-gray-500">{countryCount} selected</span>
                    </div>

                    <div className="space-y-3">
                        <span className={labelClass}>Target services</span>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={() =>
                                                setForm((current) => ({
                                                    ...current,
                                                    target_services: toggleValue(current.target_services, service.value),
                                                }))
                                            }
                                        />
                ...
                <section className="border border-gray-800 bg-gray-950 rounded-lg p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <label className="space-y-2">
                            <span className={labelClass}>Contact person / director</span>
                            <input
                                className={inputClass}
