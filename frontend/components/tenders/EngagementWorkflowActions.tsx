            ...
            <div className="absolute right-0 z-20 mt-2 flex min-w-56 flex-col gap-1 rounded-lg border border-zinc-700 bg-zinc-950 p-2 shadow-xl">
              {secondary.map((action) => (
                <button
                  ...
                  disabled={submitting !== null}
                  className="rounded-md px-3 py-2 text-left text-xs font-medium text-zinc-200 hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 disabled:opacity-60"
                >
                  {actionLabel(action)}
                </button>
              ))}
