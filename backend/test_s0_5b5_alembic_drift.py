...
def test_repository_graph_remains_at_b3_without_reconciliation_migration() -> None:
    config = Config()
    config.set_main_option("script_location", str(BACKEND_DIR / "alembic"))
    script = ScriptDirectory.from_config(config)
    assert script.get_heads() == ["20260825_0001_s0_5b3"]
    assert script.get_revision("20260825_0001_s0_5b3").down_revision == "20260824_0002_s0_4c"
    assert len(list((BACKEND_DIR / "alembic" / "versions").glob("*.py"))) == 19
